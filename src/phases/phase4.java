...
public class phase4 extends Application {
	...
	int alea;
	String reponse;
	Label titre_phase = new Label("Phase 4 : Le sans faute");
	...
	private void correction3(TextField reponseText, String reponse,Stage stage) {
		if (reponseText.getText().equals(reponse)) {
			...
			if (Scores.tour == 1) {
				...
				System.out.println("On passe à la phase 5");
			}
		}
	...
	public void settere() {
		...
		reponseText.setText("");
		joueur.setText("Au tour du joueur "+Scores.tour);
